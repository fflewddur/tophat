...
var CpuMonitor = GObject.registerClass({
    ...
    _init(settings) {
        ...
        settings.bind('meter-bar-width', this, 'meter-bar-width', Gio.SettingsBindFlags.DEFAULT);
        settings.bind('cpu-show-cores', this, 'show-cores', Gio.SettingsBindFlags.DEFAULT);
    }
