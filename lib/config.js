...
var BANDWIDTH_IN_BITS = false; // If true, represent bandwidth in bits instead of bytes
...
var ConfigHandler = class ConfigHandler {
    constructor() {
        this._settings = ExtensionUtils.getSettings('org.gnome.shell.extensions.tophat');
    }
