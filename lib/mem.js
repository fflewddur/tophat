...
class MemUse {
    constructor(memUsed = 0, memSize = 640, swapUsed = 0, swapSize = 640) {
        // this.mem = memUsed / memSize;
        this.memSize = memSize;
        this.memUsed = memUsed;
        // this.swap = swapUsed / swapSize;
    ...
    get swap() {
        return this._swapUsed / this._swapSize;
    }
    ...
    class TopHatMemMonitor extends Monitor.TopHatMonitor {
        ...
        _memInfo() {
            new FileModule.File('/proc/meminfo').read().then(lines => {
                ...
                // log(`mem total: ${(total / 1000 / 1000).toFixed(1)} GB used: ${used} (${utilized}%) swap: ${(swapTotal / 1024 / 1024).toFixed(1)} GB`);
                // this.memUsage.mem = Math.round(used / total * 100);
        ...
        _buildMenu() {
            ...
            this.menuMemSize = new St.Label({text: 'n/a', style_class: 'menu-value menu-value-details'});
            ...
            this.menuSwapSize = new St.Label({text: 'n/a', style_class: 'menu-value menu-value-details'});
