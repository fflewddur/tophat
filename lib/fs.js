...
var FileSystemMonitor = GObject.registerClass({
    ...
    _refreshFS() {
        ...
        mounts.forEach(mountPath => {
            ...
            // log(`path: ${mountPath} read: ${fsu.read * fsu.block_size} write: ${fsu.write * fsu.block_size}`);
        ...
        // log(`Disk activity: read=${readDelta} B (${diskRead}/s) write=${writeDelta} B (${diskWrite}/s) timeDelta=${timeDelta}`);
