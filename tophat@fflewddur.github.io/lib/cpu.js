...
export const CpuMonitor = GObject.registerClass({
    ...
    _init(configHandler) {
        ...
        this.gicon = Gio.icon_new_for_string(`${configHandler.metadata.path}/icons/cpu-icon-symbolic.svg`);
        this.gicon_adwaita = new Gio.ThemedIcon({ name: "media-flash-symbolic" })
